...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String> {
    ...
    private static final String URL_KEY = "SEARCH_URL";
    ...
    private void loadWeatherData() {
        ...
        String searchURL = NetworkUtils.buildUrl(location).toString();

        Bundle bundle = new Bundle();
        bundle.putString(URL_KEY, searchURL);
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                try {
                    String weatherRequestUrlString = args.getString(URL_KEY);

                    if(weatherRequestUrlString == null || TextUtils.isEmpty(weatherRequestUrlString)) { return null; }

                    URL weatherRequestUrl = new URL(weatherRequestUrlString);
