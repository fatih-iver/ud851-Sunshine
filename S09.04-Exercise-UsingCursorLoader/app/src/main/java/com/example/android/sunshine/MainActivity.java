...
public class MainActivity extends AppCompatActivity implements
    ...
    private final String[] MAIN_FORECAST_PROJECTION = {WeatherContract.WeatherEntry.COLUMN_DATE
    ...
    private final int MAX_TEMP_COLUMN_INDEX = 2;
    private final int MIN_TEMP_COLUMN_INDEX = 3;
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (0 != data.getCount()) { showWeatherDataView(); }
    }
