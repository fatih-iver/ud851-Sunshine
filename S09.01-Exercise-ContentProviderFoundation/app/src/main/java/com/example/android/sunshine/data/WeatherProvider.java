...
public class WeatherProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(WeatherContract.CONTENT_AUTHORITY.toString(), WeatherEntry.TABLE_NAME, CODE_WEATHER);
        uriMatcher.addURI(WeatherContract.CONTENT_AUTHORITY.toString(), WeatherEntry.TABLE_NAME + "/#", CODE_WEATHER_WITH_DATE);
        return  uriMatcher;
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (matcherCode) {
            case CODE_WEATHER:
                cursor = sqLiteDatabase.query(WeatherEntry.TABLE_NAME, projection, selection, selectionArgs,null,null,sortOrder);
                break;
            case CODE_WEATHER_WITH_DATE:
                ...
                break;
            default:
                throw new UnsupportedOperationException("This uri is not valid: " + uri.toString());
        }
